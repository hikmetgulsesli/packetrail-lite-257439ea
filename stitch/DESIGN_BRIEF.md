...
- PacketRail Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PacketRail Lite. It should be a full-viewport browser-game where the player redirects glowing packets between rails, collects timing bonuses, avoids overload blocks, opens a settings overlay, saves preferences, pauses and resumes, and shows score, combo, lives, and level.…
...
- Gameplay - PacketRail Lite
- Game Settings - PacketRail Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PacketRail Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PacketRail Lite
